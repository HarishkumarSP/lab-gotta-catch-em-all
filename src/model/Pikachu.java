...
public class Pikachu extends Pokemon{
	...
	public String getCharacteristics() {
		return "Pikachu is an Electric-type Pokémon, which was introduced in Generation I. Over the years, Pikachu has become so popular that it serves as the Pokémon franchise\r\n" + 
				" * mascot.";
	}
